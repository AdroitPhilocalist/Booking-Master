...
export default function RestaurantList() {
    ...
    if (loading) return <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
    <div className="bg-white p-6 rounded-lg shadow-xl flex flex-col items-center">
      ...
      <span className="mt-4 text-gray-700">Loading Menu Items...</span>
    </div>
  </div>;
