      ...
      try {
        ...
        stockReportData.stockReports.forEach(report => {
          if (report.purorsell === 'purchase' || report.purorsell === 'sell' && report.name) {
            ...
            // Access the _id from the name object
        ...
        console.log('Processed Purchase Dates:', purchaseDates);
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ backgroundColor: "#f5f5f5" }}>
                ...
                <TableCell sx={{ fontWeight: "bold", color: "#28bfdb", textAlign: "center" }}>Last Purchase Date</TableCell>
