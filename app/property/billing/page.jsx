  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-amber-50">
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, justifyContent: 'center', pt: 4 }}>
          <Box sx={{ display: 'flex', gap: 1, mb: 2 }}>
            ...
            <Button
              variant={filterStatus === "Checked Out" ? "contained" : "outlined"}
              color="primary"
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ backgroundColor: "#f5f5f5" }}>
                  ...
                  <TableCell sx={{ fontWeight: "bold", color: "#28bfdb", textAlign: "center" }}>Bill Status</TableCell>
                  <TableCell sx={{ fontWeight: "bold", color: "#28bfdb", textAlign: "center" }}>Guest Status</TableCell>
                  <TableCell sx={{ fontWeight: "bold", color: "#28bfdb", textAlign: "center" }}>Actions</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
