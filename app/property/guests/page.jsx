                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-amber-200">
                                ...
                                <tbody className="bg-white divide-y divide-amber-200">
                                    {guests.map((guest) => (
                                        <tr key={guest._id}>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-amber-900">{guest.guestName}</td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-amber-500">{guest.mobileNo}</td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-amber-500">{guest.guestEmail}</td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-amber-500">{guest.address}</td>
                        ...
                        <div className="mt-4 flex items-center justify-between">
                            <div className="flex-1 flex justify-between sm:hidden">
                                <button className="relative inline-flex items-center px-4 py-2 border border-amber-300 text-sm font-medium rounded-md text-amber-700 bg-white hover:bg-amber-50">
                                    Previous
                                </button>
                                <button className="ml-3 relative inline-flex items-center px-4 py-2 border border-amber-300 text-sm font-medium rounded-md text-amber-700 bg-white hover:bg-amber-50">
                                    Next
                                </button>
                            </div>
                            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                ...
                                <div>
                                    <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                        ...
                                        <button className="relative inline-flex items-center px-4 py-2 border border-amber-300 bg-white text-sm font-medium text-amber-700 hover:bg-amber-50">
                                            1
                                        </button>
                                        <button className="relative inline-flex items-center px-4 py-2 border border-amber-300 bg-white text-sm font-medium text-amber-700 hover:bg-amber-50">
                                            2
                                        ...
                                        <span className="relative inline-flex items-center px-4 py-2 border border-amber-300 bg-white text-sm font-medium text-amber-700">
                                            ...
                                        </span>
                                        <button className="relative inline-flex items-center px-4 py-2 border border-amber-300 bg-white text-sm font-medium text-amber-700 hover:bg-amber-50">
                                            144
